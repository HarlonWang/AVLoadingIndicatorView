...
public class AVLoadingIndicatorView extends View {
    ...
    @IntDef(flag = true,
            value = {
                    BallPulse, BallGridPulse, BallClipRotate, BallClipRotatePulse, SquareSpin,
    ...
    // attrs for BallPulse
    int mBallPulseCircleNumber;
    int mBallPulseCircleSpace;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mBallPulseCircleSpace =
                a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_ball_pulse_circle_space,
                        10);
        mBallPulseCircleNumber =
                a.getInt(R.styleable.AVLoadingIndicatorView_ball_pulse_circle_number, 3);
        ...
        switch (mIndicatorId) {
            case BallPulse:
                mIndicatorController =
                        new BallPulseIndicator(mBallPulseCircleNumber, mBallPulseCircleSpace);
                break;
            case BallGridPulse:
